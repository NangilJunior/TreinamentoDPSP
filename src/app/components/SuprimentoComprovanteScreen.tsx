...
import { PDVHeader } from "./SuprimentoValorScreen";
import { formatCurrency } from "./ValorRetiradaScreen";

interface SuprimentoComprovanteScreenProps {
  /** Valor do aporte, em centavos. */
  valorCents?: number;
  /** Saldo do caixa antes do suprimento, em centavos. */
  ...
  return (
    <div className="flex gap-[20px] h-[70px] items-center px-[64px] py-[10px] rounded-[6px] w-full">
      ...
      <div className="flex flex-col items-start">
        <p className="font-['Geist',sans-serif] font-medium text-[#707070] text-[12px] tracking-[3px] whitespace-nowrap">
          {label}
        </p>
        <p className="font-['Nunito_Sans',sans-serif] font-extrabold leading-[1.2] text-[#707070] text-[16px] whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
          {value}
        </p>
      </div>
    </div>
...
export default function SuprimentoComprovanteScreen({
  valorCents = 20000,
  saldoAnteriorCents = 50,
}: SuprimentoComprovanteScreenProps) {
  const caixaCents = saldoAnteriorCents + valorCents;
        ...
        <div className="flex gap-[32px] items-start px-[128px] w-full">
          ...
          <div className="bg-white border border-[#dbdbdb] border-solid flex-1 flex flex-col gap-[8px] items-start py-[20px] rounded-[8px]">
            <div className="flex gap-[20px] items-center px-[20px] py-[4px] w-full">
              ...
              <p className="font-['Geist',sans-serif] font-medium text-[#2d2d2d] text-[14px] tracking-[3px] whitespace-nowrap">
            ...
            <div className="flex flex-col items-start justify-center px-[64px] py-[10px] rounded-[6px] w-full">
              ...
              <p className="font-['Nunito_Sans',sans-serif] font-bold leading-[1.2] text-[#707070] text-[25.008px] whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
                R$ {formatCurrency(saldoAnteriorCents)}
              </p>
            </div>

            {/* Valor do aporte (destaque) */}
            <div className="bg-[#e7f4e2] flex flex-col items-start justify-center px-[64px] py-[10px] w-full">
              <p className="font-['Geist',sans-serif] font-medium text-[#048c0d] text-[12px] tracking-[3px] whitespace-nowrap">
                VALOR DO APORTE
              </p>
              <p className="font-['Nunito_Sans',sans-serif] font-extrabold leading-[1.2] text-[#048c0d] text-[39.056px] whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
            ...
            <div className="flex flex-col h-[71px] items-start justify-center px-[64px] py-[10px] rounded-[6px] w-full">
              <p className="font-['Geist',sans-serif] font-medium text-[#4d4d4d] text-[12px] tracking-[3px] whitespace-nowrap">
                VALOR EM CAIXA
              </p>
              <p className="font-['Nunito_Sans',sans-serif] font-bold leading-[1.2] text-[#707070] text-[25.008px] whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
                R$ {formatCurrency(caixaCents)}
              </p>
            </div>
          </div>
