    ...
    <div className="bg-white flex items-center justify-between px-[20px] py-[20px] shrink-0 w-full">
      ...
      <div className="flex gap-[16px] items-center px-[18px] py-[12px]">
        <div className="overflow-clip relative shrink-0 size-[40px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center font-['Geist',sans-serif] text-[#0a0a0a] text-[14px]">PN</div>
        </div>
        <div className="flex flex-col gap-[3px] w-[137px]">
          <p className="font-['Nunito_Sans',sans-serif] font-bold text-[#404040] text-[16px]" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>Pedro Nalini</p>
          <p className="font-['Nunito_Sans',sans-serif] text-[#404040] text-[12.8px]" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>Gerente • Mat. 12345</p>
        </div>
      </div>
      <div className="h-[32px] w-px bg-[#B9B9B9]" />
...
type CampoOperador = "matricula" | "senha";

const CAMPO_LABEL: Record<CampoOperador, string> = {
  matricula: "Matrícula do Operador",
  senha: "Senha do Operador",
};

const CAMPO_PLACEHOLDER: Record<CampoOperador, string> = {
  matricula: "Digite a matrícula do operador",
