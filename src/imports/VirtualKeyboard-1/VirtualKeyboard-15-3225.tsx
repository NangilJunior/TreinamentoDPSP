import svgPaths from "./svg-qeawom2zty";
...
export default function VirtualKeyboard() {
  return (
    <div className="bg-[#313739] content-stretch flex gap-[10px] items-start p-[40px] relative rounded-[12px] size-full" data-name="Virtual Keyboard">
      <Frame7 />
      <Frame45 />
    </div>
  );
