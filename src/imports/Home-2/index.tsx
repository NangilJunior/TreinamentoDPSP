import svgPaths from "./svg-eds7kr4w8z";
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[18px] items-center justify-center px-[240px] relative size-full">
          <Frame15 />
          <Frame14 />
        </div>
      </div>
...
function Frame8() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-w-px relative">
      <div className="content-stretch flex flex-col gap-[48px] items-start p-[20px] relative size-full">
        <Frame13 />
      </div>
    </div>
  );
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-0 px-[24px] py-[20px] top-[688px] w-[1280px]">
      <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[8px] h-[72px] items-center justify-center min-h-[40px] px-[24px] py-[10px] relative rounded-[8px] shrink-0 w-[185px]" data-name="Button">
        ...
        <div className="[word-break:break-word] flex flex-col font-['Nunito_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#ed403d] text-[20px] text-center whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
          <p className="leading-[1.2]">Voltar</p>
        </div>
      </div>
