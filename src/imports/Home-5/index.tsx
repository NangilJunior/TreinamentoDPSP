import svgPaths from "./svg-bveu4s30mg";
  ...
  return (
    <div className="bg-white col-1 content-stretch flex gap-[24px] items-center ml-0 mt-0 p-[24px] relative rounded-br-[4px] rounded-tr-[4px] row-1 w-[977px]">
      ...
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon / inbox">
        <div className="absolute inset-[13.54%_5.21%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.5 17.5">
            <g id="Vector">
              <path d={svgPaths.p2058ce00} fill="var(--fill-0, #ED403D)" />
              <path d={svgPaths.p3e596e80} fill="var(--fill-0, #ED403D)" />
            </g>
          </svg>
        </div>
      </div>
...
function Frame32() {
  return (
    <div className="content-stretch flex isolate items-start relative shrink-0 w-full">
      <div className="bg-[#ed403d] h-[72px] mr-[-1px] relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 w-[8px] z-[2]" />
      <Frame31 />
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex items-start justify-between px-[24px] py-[20px] relative shrink-0 w-[1280px]">
        ...
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Left icon">
          <div className="absolute inset-[21.88%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.99992 8.99992">
              <g id="Vector">
                <path d={svgPaths.p73f4c00} fill="var(--fill-0, #ED403D)" />
                <path d={svgPaths.p20889a80} fill="var(--fill-0, #ED403D)" />
              </g>
            </svg>
          </div>
        </div>
      ...
      <div className="bg-[#cfcfcf] content-stretch flex gap-[8px] h-[72px] items-center justify-center min-h-[40px] opacity-50 px-[24px] py-[10px] relative rounded-[8px] shrink-0 w-[185px]" data-name="Button">
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Left icon">
          <div className="absolute inset-[9.38%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
              <g id="Vector">
                <path d={svgPaths.p2010def2} fill="var(--fill-0, #3B3B3B)" />
                <path d={svgPaths.p2ef5a800} fill="var(--fill-0, #3B3B3B)" />
                <path d={svgPaths.p1d703980} fill="var(--fill-0, #3B3B3B)" />
              </g>
            </svg>
          </div>
        </div>
