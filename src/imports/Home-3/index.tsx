import svgPaths from "./svg-1kscj51chh";
...
function Frame14() {
  return (
    <div className="content-stretch flex h-full items-center justify-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon / banknote-arrow-down">
        <div className="absolute inset-[21.88%_5.21%_5.21%_5.21%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.5 17.5">
            <g id="Vector">
              <path d={svgPaths.p12d7c480} fill="var(--fill-0, #44B0E8)" />
              <path d={svgPaths.p2f881700} fill="var(--fill-0, #44B0E8)" />
              <path d={svgPaths.p3f07f800} fill="var(--fill-0, #44B0E8)" />
              <path d={svgPaths.pbcc5600} fill="var(--fill-0, #44B0E8)" />
              <path d={svgPaths.p26f80100} fill="var(--fill-0, #44B0E8)" />
              <path d={svgPaths.pde21300} fill="var(--fill-0, #44B0E8)" />
            </g>
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="h-[202px] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[18px] items-center justify-center px-[240px] relative size-full">
          <div className="bg-[rgba(255,255,255,0.4)] content-stretch flex gap-[16px] h-[72px] items-start px-[32px] py-[10px] relative rounded-[8px] shrink-0 w-[428px]" data-name="Select Button">
            <div aria-hidden className="absolute border-2 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[8px]" />
            <div className="[word-break:break-word] flex flex-col font-['Chivo_Mono',sans-serif] font-medium h-full justify-center leading-[0] relative shrink-0 text-[#878787] text-[16px] w-[10px]">
              <p className="leading-[16px]">1</p>
            </div>
            <Frame13 />
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Nunito_Sans',sans-serif] font-medium h-full justify-center leading-[0] min-w-px relative text-[#404040] text-[20px]" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
...
function Frame10() {
  return (
    <div className="content-stretch flex h-[617px] items-start relative shrink-0 w-[1280px]">
      <Frame8 />
    </div>
  );
}
