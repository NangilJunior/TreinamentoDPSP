...
function Al() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-px items-center min-w-px relative" data-name="AL">
      <p className="[word-break:break-word] font-['Nunito_Sans',sans-serif] font-medium leading-[1.2] relative shrink-0 text-[#0a0a0a] text-[20px] whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
        R$ 1.000,00
      </p>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex items-start px-[24px] py-[20px] relative shrink-0 w-[1280px]">
      <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[8px] h-[72px] items-center justify-center min-h-[40px] opacity-50 px-[24px] py-[10px] relative rounded-[8px] shrink-0 w-[185px]" data-name="Button">
        ...
        <div className="[word-break:break-word] flex flex-col font-['Nunito_Sans',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#818181] text-[20px] text-center whitespace-nowrap" style={{ fontVariationSettings: '"YTLC" 500, "wdth" 100' }}>
